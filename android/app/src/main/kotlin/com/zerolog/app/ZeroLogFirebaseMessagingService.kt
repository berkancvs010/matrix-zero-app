...
class ZeroLogFirebaseMessagingService : FirebaseMessagingService() {
    ...
    companion object {
        ...
        private const val FILE_CHANNEL_ID = "zerolog_files_v1"
        ...
        fun startIncomingCallTone(context: Context) {
            ...
            try {
                incomingCallPlayer = MediaPlayer().apply {
                    ...
                    setDataSource(
                        context,
                        Uri.parse(
                            "android.resource://${context.packageName}/${R.raw.zerolog_call}"
                        )
                    )
                ...
                android.util.Log.e(
                    "ZeroLogCall",
                    "Incoming ringtone start failed",
                    e
                )
